...
public final class OrgDtos {
    ...
    public static class CreateRequest {
         ...
         */
        @NotBlank
        @Pattern(regexp = "^[a-z0-9-]{2,60}$", message = "slug must be lowercase, digits or hyphen")
        public String slug;
         ...
         */
        @NotBlank
        @Pattern(regexp = "^[A-Za-z0-9]{4,32}$", message = "code must be alphanumeric 4-32 chars")
        public String code;
        ...
        @Min(0)
        @Max(10_000_00)  // up to ₹100,000 in paise

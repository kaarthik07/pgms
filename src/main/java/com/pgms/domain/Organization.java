...
public class Organization {
    ...
    public Integer getReferralBonusCents() {
        return referralBonusCents;
    }

    public void setReferralBonusCents(Integer referralBonusCents) {
        this.referralBonusCents = referralBonusCents;
    }
